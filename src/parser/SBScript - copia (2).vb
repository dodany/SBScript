...
Module MyParser
    ...
    Private Enum ProductionIndex
        ...
        [Methodcall_Dibujarast_Lparen_Rparen_Semi] = 53 ' <Method Call> ::= DIBUJARAST '(' <Param List> ')' ';' <nl Opt>
        [Methodcall_Dibujarexp_Lparen_Rparen_Semi] = 54 ' <Method Call> ::= DIBUJAREXP '(' <Param List> ')' ';' <nl Opt>
